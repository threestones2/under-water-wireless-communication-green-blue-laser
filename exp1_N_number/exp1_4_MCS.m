%% Exp1: MCS (LUT Accelerated, O(1) Hash Table & Zero-Allocation Scalarized)
clc; clear; close all;
...
th_axis = linspace(0, pi, 500000); pdf_vals = zeros(size(th_axis));
...
fprintf('--- 运行 MCS 收敛性测试 (O(1) 哈希 + 零分配标量加速) ---\n');
for idx = 1:num_N
...
save('data_exp1_MCS.mat', 'N_arr', 'PL_arr', 'Time_arr');
