%% Exp2: WCI-MC (Weak Turbulence, FOV Spatial Truncation)
clc; clear; close all;
...
% ================= 定义弱湍流环境 =================
turb_params.T_avg = 20; turb_params.S_avg = 35; turb_params.H_ratio = -20; 
turb_params.epsilon = 1e-6; turb_params.chi_T = 1e-7; turb_params.name = 'Weak';

% turb_params.T_avg = 20; turb_params.S_avg = 35; turb_params.H_ratio = -0.3; 
% turb_params.epsilon = 1e-4; turb_params.chi_T = 1e-7; turb_params.name = 'Weak';
...
save('data_exp2_WCIMC_Weak.mat', 'dist_cell', 'PL_Cell_WCI_Weak', 'water_types');
fprintf('已成功保存弱湍流数据至 data_exp2_WCIMC_Weak.mat\n');
