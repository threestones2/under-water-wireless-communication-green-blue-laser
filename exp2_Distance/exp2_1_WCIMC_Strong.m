%% Exp2: WCI-MC (Strong Turbulence, FOV Spatial Truncation)
clc; clear; close all;
...
save('data_exp2_WCIMC_Strong.mat', 'dist_cell', 'PL_Cell_WCI_Strong', 'water_types');
fprintf('已成功保存强湍流数据至 data_exp2_WCIMC_Strong.mat\n');
