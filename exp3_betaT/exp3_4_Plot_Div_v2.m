...
% 视觉色系规范 (固定算法映射颜色)
c_Strong = '#D95319'; c_NoTurb = '#0072BD'; 
...
lgd = legend(h_leg, {'WCI-MC (w/ Strong Turb)', 'WCI-MC (w/o Turb)', 'MCS (w/o Turb)', 'Beer Law'}, ...
    'Location', 'southwest', 'FontSize', 11, 'FontName', 'Times New Roman');

% =========================================================================
% 图 2：核心机制对比：强湍流附加损耗演化图
% =========================================================================
...
for i = 1:num_div
    ...
    h_leg_all = [h_leg_all, h_pen_strong(i)];
end
...
disp('数据可视化完毕。所有图像均按照要求 4:3 物理比例出图，已包含强湍流独立解耦加载。');