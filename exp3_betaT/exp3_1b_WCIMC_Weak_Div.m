%% Exp3.3.1b: WCI-MC Algorithm for Different Divergence Angles (Weak Turbulence)
clc; clear; close all;
...
for i = 1:num_div
    ...
    PL_Cell_WCI_Weak{i} = PL_arr_temp;
end
save('data_exp3_div_WCIMC_Weak.mat', 'dist_axis', 'div_angles_deg', 'PL_Cell_WCI_Weak', 'coef_c');
fprintf('已保存数据至 data_exp3_div_WCIMC_Weak.mat\n');
