%% Exp3.3.1a: WCI-MC Algorithm for Different Divergence Angles (Strong Turbulence)
clc; clear; close all;
...
for i = 1:num_div
    ...
    PL_Cell_WCI_Strong{i} = PL_arr_temp;
end
save('data_exp3_div_WCIMC_Strong.mat', 'dist_axis', 'div_angles_deg', 'PL_Cell_WCI_Strong', 'coef_c');
fprintf('已保存数据至 data_exp3_div_WCIMC_Strong.mat\n');
