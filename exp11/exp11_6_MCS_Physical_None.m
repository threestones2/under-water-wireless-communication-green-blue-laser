%% exp11_6: MCS Physical (No Turbulence) — Jerlov IB 距离扫描
%  纯物理接收 MCS (无湍流)：光子必须几何命中接收孔径，无任何半解析近似
...
fprintf('--- exp11_6: MCS Physical (No Turbulence) Jerlov IB 距离扫描 N=%d ---\n', N_packets);
...
save('data_exp11_MCS_Physical_None.mat', 'dist_arr', 'PL_arr', 'Time_arr', 'N_packets', 'water_type');
fprintf('已保存至 data_exp11_MCS_Physical_None.mat\n');
