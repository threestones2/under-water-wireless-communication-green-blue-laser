%% exp11_1: WCI-MC (No Turbulence) — Jerlov IB 距离扫描
...
fprintf('--- exp11_1: WCI-MC (无湍流) Jerlov IB 距离扫描 N=%d ---\n', N_packets);
...
save('data_exp11_WCIMC_None.mat', 'dist_arr', 'PL_arr', 'Time_arr', 'N_packets', 'water_type');
fprintf('已保存至 data_exp11_WCIMC_None.mat\n');
