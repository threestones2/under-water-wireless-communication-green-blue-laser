%% exp11_1: VRT-MC (No Turbulence) — Jerlov IB 距离扫描
%  无湍流 VRT-MC：弹道光子 + 散射虚拟光子，无相位屏偏折
...
fprintf('--- exp11_1: VRT-MC (无湍流) Jerlov IB 距离扫描 N=%d ---\n', N_packets);
...
save('data_exp11_VRTMC_None.mat', 'dist_arr', 'PL_arr', 'Time_arr', 'N_packets', 'water_type');
fprintf('已保存至 data_exp11_VRTMC_None.mat\n');
