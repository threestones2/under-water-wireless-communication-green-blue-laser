%% exp11_3: SA-MCS (LUT) — Jerlov IB 距离扫描
%  半解析 MCS：纯几何弹道 + 每散射节点局部估计 + LUT 散射角 O(1) 抽样
...
fprintf('--- exp11_3: SA-MCS (LUT) Jerlov IB 距离扫描 N=%d ---\n', N_packets);
...
save('data_exp11_SA_MCS_LUT.mat', 'dist_arr', 'PL_arr', 'Time_arr', 'N_packets', 'water_type');
fprintf('已保存至 data_exp11_SA_MCS_LUT.mat\n');
