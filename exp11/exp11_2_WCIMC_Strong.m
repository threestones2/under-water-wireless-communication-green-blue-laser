%% exp11_2: WCI-MC (Turbulence) — Jerlov IB 距离扫描
%  湍流 WCI-MC：弹道光子 + 散射虚拟光子 + 湍流相位屏 + Marcum Q 统计
...
fprintf('--- exp11_2: WCI-MC (湍流) Jerlov IB 距离扫描 N=%d ---\n', N_packets);
...
save('data_exp11_WCIMC_Strong.mat', 'dist_arr', 'PL_arr', 'Time_arr', 'N_packets', 'water_type');
fprintf('已保存至 data_exp11_WCIMC_Strong.mat\n');
