%% exp11_2: VRT-MC (With Turbulence) — Jerlov IB 距离扫描
...
fprintf('--- exp11_2: VRT-MC (有湍流) Jerlov IB 距离扫描 N=%d ---\n', N_packets);
...
for d_idx = 1:num_D
    [rho0_arr(d_idx), ~] = calc_turb_coherence_params(Phi_func, k_wave, dist_arr(d_idx), eta_physical);
    fprintf('  L=%2dm: rho0=%.4fm\n', dist_arr(d_idx), rho0_arr(d_idx));
end
fprintf('\n');
...
save('data_exp11_VRTMC.mat', 'dist_arr', 'PL_arr', 'Time_arr', 'N_packets', 'water_type');
fprintf('已保存至 data_exp11_VRTMC.mat\n');
