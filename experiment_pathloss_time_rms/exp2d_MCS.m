%% 4. MCS vs Distance (Local Estimation + LUT, No Turbulence)
clc; clear; close all;
...
for d_idx = 1:length(dist_array)
    ...
    for p = 1:N_packets
        ...
        for order = 1 : n_max
            ...
            dir = rotate_direction(dir, interp1(cdf_vals, th_axis, rand(), 'linear', 'extrap'), 2*pi*rand());
        end
    end
    t_run = toc;
