%% Exp7: WCI-MC Pointing Error Simulation (Weak Turbulence Only)
clc; clear; close all;
...
fprintf('--- 运行 Exp7: WCI-MC (Weak Turbulence) ---\n');
...
for w_idx = 1:num_W
    ...
    PL_Cell_WCI_Weak{w_idx} = PL_matrix;
end
save('data_exp7_WCIMC_Weak.mat', 'dist_cell', 'PL_Cell_WCI_Weak', 'water_types', 'off_axis_angles');
