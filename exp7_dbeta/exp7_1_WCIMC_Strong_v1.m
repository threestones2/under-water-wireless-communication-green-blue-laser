...
% 实验目的: 分析收发偏轴误差对链路衰减的影响 (包含强湍流影响的无偏估计)
clc; clear; close all;
...
fprintf('--- 运行 Exp7: WCI-MC (Strong Turbulence_v1) ---\n');
                ...
                for ord = 1:n_max
                    ...
                    if base_w > 1e-16
                        ...
                        if v_hit
                            ...
                            % [核心修复]: 宽广球面散射波在强湍流下宏观均值守恒
                            % 仅保留基于 r_wp 的微观物理偏移评估，移除重复的孤立光束展宽惩罚 W_ST
