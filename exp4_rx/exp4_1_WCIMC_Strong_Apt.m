%% Exp4_1: WCI-MC Algorithm for Different Receiver Apertures (Strong Turbulence)
clc; clear; close all;
...
Rx_Aperture_Base = 0.01; % 基础孔径（保留以兼容部分参数）
...
PL_Cell_WCI_Strong = cell(1, num_apt);
...
save('data_exp4_apt_WCIMC_Strong.mat', 'dist_axis', 'apertures_m', 'PL_Cell_WCI_Strong');
