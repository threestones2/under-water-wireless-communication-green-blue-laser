%% exp10_1: VRT-MC (No Turbulence) — 光子数扫描
...
fprintf('--- exp10_1: VRT-MC (无湍流) 光子数扫描 ---\n');
...
save('data_exp10_VRTMC_None.mat', 'dist_cell', 'PL_Cell', 'Time_Cell', 'N_packets_arr', 'water_types');
fprintf('已保存至 data_exp10_VRTMC_None.mat\n');
